...
!function (a) {
    ...
    b.DEFAULTS = {
        ...
        return this.each(function () {
            var d = a(this), e = d.data("countTo"), f = !e || "object" == typeof c, g = "object" == typeof c ? c : {},
    ...
    a.fn.appear = function (b, c) {
        ...
        return this.each(function () {
            ...
            var e = a(window), f = function () {
                ...
                var a = e.scrollLeft(), b = e.scrollTop(), f = c.offset(), g = f.left, h = f.top, i = d.accX,
                    j = d.accY, k = c.height(), l = e.height(), m = c.width(), n = e.width();
...
!function (a) {
    a.fn.skillBars = function (b) {
        var c = a.extend({
            ...
            onUpdate: null,
            onComplete: null,
            classes: {skillBarBar: ".skillbar-bar", skillBarPercent: ".skill-bar-percent"}
        }, b);
        return this.each(function () {
            function j() {
            ...
            var b = a(this), d = 0 != c.to ? c.to : parseInt(b.attr("data-percent"));
            d > 100 && (d = 100);
            var e = c.from, f = Math.ceil(c.speed / c.interval), g = (d - e) / f, h = 0, i = setInterval(j, c.interval);
            b.find(c.classes.skillBarBar).animate({width: parseInt(b.attr("data-percent")) + "%"}, c.speed)
        })
    }
}(jQuery);
...
!function (jQuery, ytp) {
    jQuery.mbYTPlayer = {
        ...
        play: function () {
            ...
            a.player.playVideo(), a.wrapper.CSSAnimate({opacity: a.isAlone ? 1 : a.opt.opacity}, a.opt.fadeOnStartTime), jQuery(a.playerEl).is(":visible") || jQuery(a.playerEl).CSSAnimate({opacity: 1}, 2 * a.opt.fadeOnStartTime);
        ...
        checkForStart: function (a) {
            ...
            if (a.preventTrigger = !0, a.state = 2, jQuery(a).YTPPlay(), jQuery(a).YTPPause(), jQuery(a).muteYTPVolume(), jQuery("#controlBar_" + a.id).remove(), a.controlBar = !1, a.opt.showControls && jQuery.mbYTPlayer.buildControls(a), a.overlay) if (a.opt.addRaster) {
            ...
            a.start_from_last = null, a.player.playVideo(), a.player.seekTo(d, !0), clearInterval(a.checkForStartAt), jQuery(a).YTPMute(), a.checkForStartAt = setInterval(function () {
                ...
                if (a.player.getDuration() > 0 && a.player.getCurrentTime() >= d && c) {
                    ...
                    if (e.time = a.currentTime, jQuery(a).trigger(e), a.preventTrigger = !0, a.state = 2, jQuery(a).YTPPause(), a.opt.mute || jQuery(a).YTPUnmute(), a.preventTrigger = !1, a.opt.autoPlay) {
                        ...
                        a.player.pauseVideo(), a.player.seekTo(d, !0), a.isPlayer || (jQuery(a.playerEl).CSSAnimate({opacity: 1}, a.opt.fadeOnStartTime), a.wrapper.CSSAnimate({opacity: a.isAlone ? 1 : a.opt.opacity}, a.opt.fadeOnStartTime))
        ...
        if (YTPlayer.opt.optimizeDisplay) {
            var abundance = YTPlayer.isPlayer ? 0 : 180, win = {}, el = YTPlayer.wrapper;
...
function sizeEverything() {
    dimensions = coverDimensions(16, 9, window.innerWidth, window.innerHeight), $el.css({
        ...
        "max-width": "none"
    }), $wrap.css({position: "relative", overflow: "hidden", width: window.innerWidth, height: window.innerHeight})
}

var $iframe = $("iframe[data-fullscreeneo]"), max = function (i, e) {
    return i > e ? i : e
...
var $wrap = $(".fullscreeneo-wrap"), $el = $(".fullscreeneo-video-container");
...
$(function () {
    "use strict";
    var l = new ScrollMagic.Controller, o = $(".element-color-switch");
    $.each(o, function (o, e) {
        var n = $(e), i = n.outerHeight();
